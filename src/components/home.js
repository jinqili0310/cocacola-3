 ...
 * @LastEditTime: 2020-11-02 10:46:15
 * @FilePath: /cocacola-3/src/components/home.js
 */
					...
					<Col className="col-card">
						<Card className="product-card product-cc">
							...
							<Card.Body className="product-card-body">
								...
								<Button variant="dark" className="button-style" href="/cocacola-3/#/products/coca-cola/explore/">
									EXPLORE
								</Button>
							</Card.Body>
						</Card>
